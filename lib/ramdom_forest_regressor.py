...
class RandomForestRegressor_(BaseRegressor):
    ...
    def __init__(self, X=None, y=None, train_test_split_params=None, grid_search_cv_params=None, random_forest_regressor_params=None):
        ...
        if random_forest_regressor_params is not None:
            self.random_forest_regressor_params = random_forest_regressor_params

    def grid_search(self, X_train=None, y_train=None):
        logger.info(f"Start: Grid Search")
        logger.info(f"Grid Search Params: {self.random_forest_regressor_params}")
        ...
        gscv = GridSearchCV(RandomForestRegressor(), self.random_forest_regressor_params, **self.grid_search_cv_params)
