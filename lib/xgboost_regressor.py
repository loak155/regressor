...
class XGBRegressor_(BaseRegressor):
    ...
    def __init__(self, X=None, y=None, train_test_split_params=None, grid_search_cv_params=None, xgregressor_params=None):
        ...
        if xgregressor_params is not None:
            self.xgregressor_params = xgregressor_params

    def grid_search(self, X_train=None, y_train=None):
        logger.info(f"Start: Grid Search")
        logger.info(f"Grid Search Params: {self.xgregressor_params}")
        ...
        gscv = GridSearchCV(XGBRegressor(), self.xgregressor_params, **self.grid_search_cv_params)
